---
name: "sop-scaffold"
description: "Create the minimal runnable physical anchor for a new project, package, module, or feature area. Triggers: sop-scaffold, '新建项目', '初始化项目', 'bootstrap project', '搭建骨架', 'create project'."
---
...
- 目标过远且缺少工作面时 transition 到 `expand`；骨架可运行后 transition 到后续 action。
